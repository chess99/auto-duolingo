...
def ocr_from_image(image_path):
    ...
    data = pytesseract.image_to_string(
        image, lang='eng+chi_sim+jpn', output_type=Output.DICT)
...
def mark_recognized_text_on_image(image_path, text_positions, output_path):
    ...
    for item in text_positions:
        ...
        text_position = (x, y - 10 if y - 10 > 0 else y + h)
...
for item in text_positions:
    print(item)
mark_recognized_text_on_image(
    '.temp/big_image.png', text_positions, '.temp/res2.png')
